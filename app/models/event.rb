class Event < ApplicationRecord
  ...
  # Ahead of the update so occurrences regenerated by this save can pick from
  # the new images rather than the pool as it was before.
  before_update :attach_pool_images
  ...
  attr_reader :pool_images_attached_count
  ...
  def attach_pool_images
    ...
    @pool_images_attached_count = attach_pool_images_from_uploads(files)
  end
